...
//      masterOrderCatalog = moc;
    ...
    private void initComponents() {
        ...
        btnSupplierProfile.setBackground(new java.awt.Color(204, 255, 204));
        ...
        btnManageStaff.setBackground(new java.awt.Color(255, 204, 51));
        btnManageStaff.setText("Manage Staff");
        btnManageStaff.setEnabled(false);

        Performance.setBackground(new java.awt.Color(255, 204, 102));
...
//        layout.next(userProcessContainer);
    ...
    private void btnSupplierProfileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSupplierProfileActionPerformed
        // TODO add your handling code here:
        UpdateSupplierPanel usp = new UpdateSupplierPanel (workArea, supplier);
        workArea. add ("UpdateSupplierPanel", usp) ;
        CardLayout layout = (CardLayout) workArea. getLayout () ;
        layout. next (workArea) ;
